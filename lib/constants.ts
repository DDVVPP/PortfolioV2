...
export const artImageOrderAndTitle = [
  ...
  { altText: 'day-2-spider', customTitle: 'Sketch from Memory: Unnerved' },
  { altText: 'day-4-pipe-worms', customTitle: 'Sketch from Memory: Burst' },
  {
  ...
  { altText: 'jellyfish-2', customTitle: 'Jellyfish' },
  ...
  { altText: 'hat-glazeware-2', customTitle: 'Hat Bowl' },
  { altText: 'beehive-vase' },
  { altText: 'ramen-glazeware-1', customTitle: 'Ramen Bowl' },
  { altText: 'ramen-glazeware-2', customTitle: 'Bowl' },
  { altText: 'bubble-vase-1', customTitle: 'View 1: Bubble Vase' },
  { altText: 'bubble-vase-2', customTitle: 'View 2: Bubble Vase' },
  { altText: 'quizzical-figure', customTitle: 'Greenware: Quizzical Figure' },
  { altText: 'undulating-planter' },
  { altText: 'worm-vase' },
  { altText: 'mask-1', customTitle: 'View 1: Mask' },
  { altText: 'mask-2', customTitle: 'View 2: Mask' },
  ...
  { altText: 'loopy-man-glazed-3', customTitle: 'Glazed: Loopy Dude' },
];
