...
const Navbar = () => {
  ...
  return (
    <section className="sticky flex flex-col gap-y-10">
      <section className="flex items-center justify-between">
        <Link
          href="/about"
          className="text-4xl font-bold text-slate-400 duration-300 hover:text-red-300 max-sm:text-base"
        >
          <h1>Darshin</h1>
          <h1>Van Parijs</h1>
        </Link>
        ...
        <div className="mt-0 flex flex-col gap-y-1">
          <div className="mb-0.5 flex items-center justify-end gap-x-[18px] font-light text-slate-300 max-sm:text-xs">
            <a
          ...
          <div className="flex justify-end">
            <a
              ...
              className="rounded-md border border-slate-500 p-1 text-end font-light text-slate-300 max-sm:text-xs"
            >
              darshinvp@gmail.com
            </a>
          </div>
      ...
      <section className="flex justify-between text-base font-light text-slate-400 max-sm:text-sm">
