    ...
    >
      ...
      <div className="mt-7 w-4/5 justify-center max-md:w-full max-md:text-sm xl:mt-10 xl:w-3/4">
        <p className="text-center font-light text-slate-300">
          ...
          frequent changes, which have honed my ability to adapt quickly and
          stay calm under pressure. I’ve carried these skills into my software
          development career, allowing me to address diverse project needs
          effectively.
          <br />
